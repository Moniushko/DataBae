...
class Thread extends Eloquent
{
    ...
    public function creator()
    {
        if (is_null($this->creatorCache)) {
            ...
            $this->creatorCache = $firstMessage ? $firstMessage->user : \Auth::user();
        }
    ...
    {
        $participantsTable = 'messenger_participants';
        $threadsTable = 'messenger_threads';
    ...
    {
        $participantTable = 'messenger_participants';
        $threadsTable = 'messenger_threads';
    ...
    public function participantsString($userId = null, $columns = ['username'])
    {
        $participantsTable = 'messenger_participants';
        $usersTable = 'users';
        $userPrimaryKey = \Auth::user()->getKeyName();
